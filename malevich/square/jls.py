...
def processor(id: Optional[str] = None, finish_msg: Optional[str] = None, drop_internal: bool = True, get_scale_part_all: bool = False, cpu_bound: bool = False, tags: Optional[Dict[str, str]] = None, is_stream: bool = False, **kwargs):   # noqa: ANN201, E501
...
def output(id: Optional[str] = None, collection_name: Optional[str] = None, collection_names: Optional[List[str]] = None, finish_msg: Optional[str] = None, drop_internal: bool = True, cpu_bound: bool = False, tags: Optional[Dict[str, str]] = None, **kwargs):    # noqa: ANN201, E501
    def wrapper(fun: Callable) -> Callable:
        return fun
    return wrapper


def condition(id: Optional[str] = None, finish_msg: Optional[str] = None, drop_internal: bool = True, cpu_bound: bool = False, tags: Optional[Dict[str, str]] = None, **kwargs):  # noqa: ANN201, E501
...
def init(id: Optional[str] = None, enable: bool = True, tl: Optional[int] = None, prepare: bool = False, cpu_bound: bool = False, tags: Optional[Dict[str, str]] = None, **kwargs):   # noqa: ANN201, E501
